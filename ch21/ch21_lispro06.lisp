;21. 여러 프로세스
;이전 장에서는 continuations는 실행 프로그램 자체의 상태를 잡아, 그리고 나중에 다시 시작하기 위하여 그것을 멀리 저장할 수있는 방법을 보여주었다. 이 장에서는 컴퓨터가 아니라 하나의 프로그램이 아니라 독립된 프로세스의 모음을 실행하는 계산의 모델을 다룹니다. 프로세스의 개념은 프로그램의 상태를 우리의 개념과 긴밀하게 해당합니다. 이전 장에서 그 위에 매크로의 추가 계층을 작성함으로써, 우리는 일반적인 LISP 프로그램에서 멀티를 추가할 수 있습니다.
;21.1 프로세스 추상화
